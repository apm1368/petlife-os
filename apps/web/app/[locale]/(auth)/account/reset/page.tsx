...
function ResetPasswordFlow() {
  ...
  return (
    <div className="flex flex-col gap-5">
      <h1 className="text-page-title text-text-primary">{t("reset.title")}</h1>
      <PasswordInput label={t("reset.newPasswordLabel")} autoComplete="new-password" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} errorMessage={error ?? undefined} autoFocus />
