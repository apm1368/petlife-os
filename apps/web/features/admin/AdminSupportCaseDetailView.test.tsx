...
describe("AdminSupportCaseDetailView", () => {
  beforeEach(() => {
    ...
    vi.mocked(adminService.getSupportCaseContext)
      .mockReset()
      .mockResolvedValue({ household: null, pet: null, relatedEntity: null, previousCases: [], firstResponseAt: null, firstResponseTimeMinutes: null, resolutionTimeMinutes: null, subscription: null, health: null, lostPet: null });
